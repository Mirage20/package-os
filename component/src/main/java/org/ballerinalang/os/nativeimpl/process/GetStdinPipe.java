...
/**
 * Extern function mirage/os:Command.getStdinPipe.
 */
@BallerinaFunction(
        orgName = "mirage",
...
public class GetStdinPipe extends BlockingNativeCallableUnit {
    @Override
    public void execute(Context context) {
        ...
        try {
            context.setReturnValues(process.getStdinChannel(context));
        } catch (Exception e) {
