...
/**
 * Extern function mirage/os:Command.getStdoutPipe.
 */
@BallerinaFunction(
        orgName = "mirage",
        packageName = "os:0.0.0",
        functionName = "getStdoutPipe",
...
public class GetStdoutPipe extends BlockingNativeCallableUnit {
    @Override
    public void execute(Context context) {
        ...
        try {
            context.setReturnValues(process.getStdoutChannel(context));
        } catch (Exception e) {
